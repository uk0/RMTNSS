...
public class GlobalConfig{
    ...
    final static String SERVER_ADDR = "remoteIpAddress";
    final static String LOCAL_PORT = "localPort";
    final static String SERVER_PORT = "remotePort";
    ...
    public static void getConfigFromFile(String type) throws ClassCastException{
//        String name = GlobalConfig.get().getConfigFile();
        String name = "conf/conf_"+type+".json";
        if (name == null)
            return;
