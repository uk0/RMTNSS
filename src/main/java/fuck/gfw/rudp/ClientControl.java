...
public class ClientControl {
	public static Logger log = LogManager.getLogger(fuck.gfw.rudp.ClientControl.class.getName());
	int clientId;
	...
	public void onReceivePacket(DatagramPacket dp){
		...
		if(sType== MessageType.sType_PingMessage){
			...
			if(t!=null){
				...
				log.info("Pipeline "+protocal+" "+pingDelay+"MS "+dp.getAddress().getHostAddress()+":"+dp.getPort());
			}
		}
	}
